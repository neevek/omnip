...
const SOURCE_DIR: &str = &"src/omnip-web/dist/";
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let blob_file_path = Path::new(&out_dir).join("omnip-web.blob");
    // index into the omnip-web.blob file, in the format of [filepath offset length]
    let blob_index_file_path = Path::new(&out_dir).join("omnip-web.idx");
